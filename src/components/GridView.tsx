  ...
  if (cards.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-32 text-center">
        ...
        <p className="text-white/30 text-sm mb-3">No color cards yet.</p>
        <Link
          to="/"
            ...
            <div className="p-4">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  className="px-2.5 py-1 text-white/40 hover:text-white bg-surface-raised hover:bg-surface-overlay text-xs rounded-lg transition-all border border-surface-border"
                >
                  PNG
                </button>
                <button
                  onClick={() => setExportCodeId(card.id)}
                  className="px-2.5 py-1 text-white/40 hover:text-white bg-surface-raised hover:bg-surface-overlay text-xs rounded-lg transition-all border border-surface-border font-mono"
                >
                  {'</>'}
                </button>
                <button
                  onClick={() => setConfirmId(card.id)}
                  className="ml-auto p-1 text-white/15 hover:text-accent-rose opacity-0 group-hover:opacity-100 transition-all"
                  title="Delete"
                >
